          ...
          controls: [
            {
              ...
              label: 'On',
              apiCommands: [
                { type: 'zum', payloads: [{ room: 'samarpan', scene: '1' }] },
              ],
            },
            {
              kind: 'light',
              ...
              label: 'Crown',
              apiCommands: [
                { type: 'zum', payloads: [{ room: 'samarpan', scene: '2' }] },
              ],
            },
            {
              kind: 'light',
              ...
              label: 'Ceiling',
              apiCommands: [
                { type: 'zum', payloads: [{ room: 'samarpan', scene: '3' }] },
              ],
            },
            {
              kind: 'light',
              ...
              apiCommands: [
                {
                  type: 'zum',
                  payloads: [{ room: 'samarpan', scene: '16' }],
                },
              ],
            },
            {
              ...
              apiCommands: [
                ...
                {
                  type: 'pharos',
                  payloads: [{ room: 'samarpan', scene: '01' }],
                },
              ],
            },
            {
              ...
              apiCommands: [
                ...
                {
                  type: 'pharos',
                  payloads: [{ room: 'samarpan', scene: '00' }],
                },
              ],
            },
          ],

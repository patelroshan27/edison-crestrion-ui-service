          ...
          controls: [
            {
              ...
              label: 'On',
              apiCommands: [
                { type: 'zum', payloads: [{ room: 'gnan', scene: '1' }] },
              ],
            },
            {
              kind: 'light',
              ...
              label: 'Crown',
              apiCommands: [
                { type: 'zum', payloads: [{ room: 'gnan', scene: '2' }] },
              ],
            },
            {
              kind: 'light',
              ...
              label: 'Ceiling',
              apiCommands: [
                { type: 'zum', payloads: [{ room: 'gnan', scene: '3' }] },
              ],
            },
            {
              kind: 'light',

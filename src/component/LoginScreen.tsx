      ...
      <div className="flex flex-col items-center justify-center w-full max-w-4xl px-4">
        ...
        <div className="grid grid-cols-3 gap-3 w-full max-w-sm">
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((digit) => (
            <button
              key={digit}
              className="outline-none focus:outline-none flex items-center justify-center rounded-full h-28 w-28 text-4xl border-2 border-neutral-700 bg-neutral-400 opacity-80 font-medium active:opacity-100 hover:opacity-100 !bg-secondary-foreground text-primary mob:h-20 mob:w-20 mob:text-2xl"
              disabled={isLoading}
              onClick={() => {
          ...
          <div className="col-span-3 grid grid-cols-3 gap-3 sm:gap-4 md:gap-6">
            <button
              className="invisible outline-none focus:outline-none flex items-center justify-center rounded-full h-28 w-28 border-2 border-neutral-700 bg-neutral-400 opacity-80 font-medium active:opacity-100 hover:opacity-100 !bg-secondary-foreground text-primary"
            ...
            <button
              className="outline-none focus:outline-none flex items-center justify-center rounded-full h-28 w-28 border-2 border-neutral-700 bg-neutral-400 opacity-80 font-medium active:opacity-100 hover:opacity-100 !bg-secondary-foreground text-primary mob:h-20 mob:w-20"
              disabled={isLoading}
              onClick={() => {
                void handleDigitClick(-1);
              }}>
              <Delete className="h-8 w-8 mob:h-6 mob:w-6" />
            </button>
          </div>
        </div>
      </div>

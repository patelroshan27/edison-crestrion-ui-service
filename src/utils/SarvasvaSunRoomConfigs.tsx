...
const SarvasvaSunRoomConfigs: UIConfig = {
  id: 123,
    ...
    LIGHTS: {
      ...
      controls: {
        ...
        scene2: {
          ...
          icon: icon({ name: 'lightbulb' }),
          title: 'Lights',
          label: 'Sitting 1 & Nilkanth Varni',
          state: '2',
          stateOff: '20',
          intensityStates: [
            { state: '10', stateOff: '2', name: 'Medium' },
            { state: '11', stateOff: '2', name: 'Low' },
          ],
        },
        scene3: {
          kind: 'toggle',
          icon: icon({ name: 'lightbulb' }),
          title: 'Lights',
          label: 'Sitting 2 & Nilkanth Varni',
          state: '3',
          stateOff: '20',
          intensityStates: [
            { state: '12', stateOff: '3', name: 'Medium' },
            { state: '13', stateOff: '3', name: 'Low' },
          ],
        },
        scene4: {
          kind: 'toggle',
          icon: icon({ name: 'lightbulb' }),
          title: 'Lights',
          label: 'Nilkanth Varni',
          state: '4',
          stateOff: '20',
          intensityStates: [
            { state: '14', stateOff: '4', name: 'Medium' },
            { state: '15', stateOff: '4', name: 'Low' },
          ],
        },
        scene5: {
          kind: 'toggle',
          ...
          stateOff: '20',
          intensityStates: [
            { state: '8', stateOff: '5', name: 'Medium' },
            { state: '9', stateOff: '5', name: 'Low' },
          ],
        },
      },
    },
...
export default SarvasvaSunRoomConfigs;
